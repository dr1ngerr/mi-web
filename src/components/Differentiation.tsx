...
export function Differentiation() {
  return (
    <section id="diferenciacion" className="relative overflow-hidden border-y border-slate-800 bg-slate-950 py-14 text-white sm:py-28">
      <div
        aria-hidden
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mt-4 text-lg font-medium leading-relaxed text-slate-200 sm:mt-6 sm:text-xl">
            {differentiationContent.text}
          </p>
          <p className="mt-4 text-base leading-relaxed text-slate-400">
            {differentiationContent.detail}
          </p>
